...
export default class DaysOfWeekHasClients {
	...
	@ManyToMany(() => DaysOfWeek, days_of_week_id_days_of_week => days_of_week_id_days_of_week.id_days_of_week)
	...
	@OneToOne(() => HourOfExercise, hour_of_exercise_id_hour_of_exercise => hour_of_exercise_id_hour_of_exercise.id_hour_of_exercise)
