...
export default class ClientsHasExercise {
  ...
  @ManyToMany(
    () => Exercises,
    (exercises_id_exercises) => exercises_id_exercises.id_exercises
  )
  @JoinColumn({ name: 'id_exercises' })
  exercises_id_exercises: Exercises;

  @OneToOne(
    () => ExercisesQuantityNumber,
    (exercises_quantity_number_id_exercises_quantity_number) =>
      exercises_quantity_number_id_exercises_quantity_number.id_exercises_quantity_number
  )
  ...
  @OneToOne(
    () => ExercisesSeriesQuantity,
    (exercises_series_quantity_id_exercises_series_quantity) =>
      exercises_series_quantity_id_exercises_series_quantity.id_exercises_series_quantity
  )
